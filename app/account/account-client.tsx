  ...
  const profileContent = (
    <div className="relative min-h-[85vh] px-4 py-12 sm:py-20 overflow-hidden">
      ...
      <div className="mx-auto w-full max-w-5xl relative z-10">
        ...
        {success && (
          <div className="mt-6 flex items-center gap-3 rounded-2xl border border-emerald-200/50 bg-emerald-50/80 p-4 text-sm font-medium text-emerald-800 backdrop-blur-sm shadow-sm dark:border-emerald-950/30 dark:bg-emerald-950/30 dark:text-emerald-400">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {activeTab === 'settings' && (
                <div className="rounded-3xl border border-border/50 bg-card/60 backdrop-blur-xl shadow-xl overflow-hidden">
                  <div className="flex items-center justify-between border-b border-border/50 bg-muted/10 px-5 py-4">
                    <h3 className="text-sm font-bold text-foreground">তথ্য পরিবর্তন</h3>
                  </div>
